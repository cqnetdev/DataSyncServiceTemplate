...
namespace SyncDataService
{
    ...
    public class TList<T> : IList<T>
    {
        ...
        /// </summary>
        private readonly ReaderWriterLock LockList = new ReaderWriterLock();
        ...
        public IEnumerator GetEnumerator()
        {
            ...
            // init enumerator
            LockList.AcquireReaderLock(3000);
            try
            {
        ...
        {
            LockList.AcquireWriterLock(3000);
            try
            {
                m_TList.Add(item);
            }
    ...
    public class EmailKeeper
    {
        ...
        public int RemainSendCount { get; set; }
